...
if len(experiment_events) > 0:
    ...
    fig.suptitle('Analysis of experiments', fontsize=16, fontweight='bold')
    ...
    axes[0, 0].set_title('Overall conversion across experiments', fontweight='bold')
    ...
    axes[0, 1].set_title('Lift vs. control group', fontweight='bold')
    ...
    axes[1, 0].set_title('Sample size for experiments', fontweight='bold')
    ...
    print("\nГрафик анализа экспериментов сохранен как 'experiment_analysis_EN.png'")
